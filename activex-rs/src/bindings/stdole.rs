...
com::interfaces! {
    ...
    /// NOTE: The following class is NOT autogenerated, because it does not
    /// have a TypeLib to autogenerate from
    #[uuid("0000000F-0000-0000-C000-000000000046")]
    pub unsafe interface IMoniker: IUnknown {
    ...
    pub unsafe interface IOleContainer: IUnknown {
